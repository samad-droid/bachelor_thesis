...
inline const int numFlats = 6;
inline const double originSpread = 5.0;
inline const double coordExtent = 1.0;
inline const double noiseStd = 0.3;
inline const int numDataPointsPerFlat = 300;
// ===== RANSAC Parameters =====
inline constexpr int MIN_INLIERS = numDataPointsPerFlat * 0.3;
inline constexpr int RANSAC_ITERATIONS = 1000;
inline constexpr double RANSAC_THRESHOLD = 0.38;
inline constexpr int FIXED_DIMENSION = 1;
// ===== RNG =====
inline std::random_device rd;
inline std::mt19937 rng(144);
