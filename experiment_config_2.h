...
inline constexpr int MIN_INLIERS = 25;
inline constexpr int RANSAC_ITERATIONS = 1200;
...
inline const std::string face_smallCSV = "../face_data_pca_10_subjects_random.csv";
